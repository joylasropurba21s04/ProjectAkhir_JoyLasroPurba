package com.joylasropurba.projectakhir_joylasropurba.db;
...
import com.joylasropurba.projectakhir_joylasropurba.model.Masyarakat;
...
public class DbHelper extends SQLiteOpenHelper {
    ...
    @Override
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion){ //Perintah DDL untuk
        // upgrade Tabel, dalam hal ini menghapus tabel
